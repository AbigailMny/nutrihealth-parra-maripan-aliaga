...
import com.recetas.api_recetas.security.JwtAuthenticationFilter;
import com.recetas.api_recetas.security.JwtService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
		return http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/api/v1/recetas/v3/api-docs", "/error").permitAll()
