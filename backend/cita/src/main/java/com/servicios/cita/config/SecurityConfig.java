package com.servicios.cita.config;

import com.servicios.cita.security.JwtAuthenticationFilter;
import com.servicios.cita.security.JwtService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
		return http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/api/v1/citas/v3/api-docs", "/api/v1/citas/v3/api-docs/**", "/error").permitAll()
