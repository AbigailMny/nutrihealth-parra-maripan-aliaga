...
import com.antecedentes.api_antecedentes.security.JwtAuthenticationFilter;
import com.antecedentes.api_antecedentes.security.JwtService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
		return http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/api/v1/antecedentes/v3/api-docs", "/error").permitAll()
